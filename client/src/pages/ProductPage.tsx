          ...
          <>
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12 max-md:gap-5">
              <div className="space-y-4 max-md:space-y-2">
                ...
                {images.length > 1 ? (
                  <div className="flex gap-3 flex-wrap max-md:flex-nowrap max-md:overflow-x-auto max-md:gap-2 max-md:pb-1 max-md:pt-1 max-md:snap-x max-md:snap-mandatory max-md:[scrollbar-width:thin]">
                    {images.map((img, index) => (
                      <button
                        key={`${index}-${img}`}
                        type="button"
                        onClick={() => selectGalleryIndex(index)}
                        className={`relative w-20 h-20 max-md:w-16 max-md:h-16 shrink-0 max-md:snap-start rounded-lg overflow-hidden border-2 transition-all ${
              ...
              <div className="flex min-w-0 flex-col gap-6 max-md:gap-4">
                <div>
                  {product.brand ? (
                  ...
                  <h1 className="text-3xl lg:text-4xl font-bold tracking-tight mb-4 text-balance max-md:mb-2 max-md:text-xl max-md:leading-snug max-md:line-clamp-4">
                    {product.title}
                  </h1>
                  ...
                  <div className="flex items-center gap-3 mb-4 max-md:flex-wrap max-md:gap-x-2 max-md:gap-y-1 max-md:mb-2">
                    ...
                    <span className="text-sm text-muted-foreground max-md:text-xs">
                  ...
                  <p className="text-muted-foreground leading-relaxed max-md:text-sm max-md:leading-snug max-md:line-clamp-3">
                    {product.description}
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 max-md:gap-2.5 sm:flex-row sm:flex-wrap">
                  <Button className="w-full flex-1 gap-2 max-md:min-h-11 max-md:text-sm sm:w-auto" disabled={adding} onClick={addToCart}>
                    <ShoppingBag className="h-5 w-5 max-md:h-5 max-md:w-5" />
                    {adding ? 'Adding…' : 'Add to Cart'}
                  </Button>
                  <div className="flex gap-2 max-md:gap-2 sm:contents">
                  <Button
                    variant="outline"
                    className="min-w-0 flex-1 gap-2 max-md:min-h-11 max-md:flex-1 max-md:text-sm sm:flex-1"
                    onClick={() => {
                      if (!product) return
                  ...
                  >
                    ...
                    <span className="hidden max-md:inline text-sm font-medium">Share</span>
                  </Button>
                  </div>
                </div>
